    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold">Smart Violation Monitor</CardTitle>
          <CardDescription>Sign in to access your camera monitoring dashboard</CardDescription>
        </CardHeader>
        <CardContent>
